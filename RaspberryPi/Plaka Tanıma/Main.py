...
try:
    ...
    server.starttls()
    server.login("aekoksal@gmail.com", "vvdrldenncpwegyw")
except:
    print("SMTP ERROR")
...
##    server.sendmail("aekoksal@gmail.com", "aekoksal@gmail.com", msg)
    try:
        msg = MIMEMultipart()
        msg['Subject'] = dateTime
        msg['From'] = "aekoksal@gmail.com"
        msg['To'] = "mmertm54@gmail.com"
        fp = open('1.png', 'rb')
...
##
        ...
        try:
            ...
            ##server.sendmail("aekoksal@gmail.com", "mmertm54@gmail.com", msg.as_string())
        except:
...
if __name__ == "__main__":
    print("BASLANGIC BASARILI")
    while True:
        subprocess.call("fswebcam -d /dev/video0 -r 1920x1080 -S0 ../frame.png",shell=True)
        main()
        time.sleep(2)
